<section id="slider">
        <div class="flexslider loading">
            ...
            <ul class="slides">
                <li class="slide slide-has-parallax"><img src="<?=site_url('assets/img/slide1.jpg');?>" class="img-responsive " alt=""></li>
                <li class="slide slide-has-parallax"><img src="<?=site_url('assets/img/slide2.jpg');?>" class="img-responsive " alt=""></li>
                <li class="slide slide-has-parallax"><img src="<?=site_url('assets/img/slide3.jpg');?>" class="img-responsive" alt=""></li>
        ...
        <!-- <div class="slider-banner"> -->
            <!-- <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 more-information">
